        ...
        if (intent != null) {
            ...
            if (ACTION_PROCESS_UPDATES.equals(action)) {
                ...
                if (result != null) {
                    ...
                    com.wot.wotcursdk.LocationResultHelper locationResultHelper = new com.wot.wotcursdk.LocationResultHelper(this,
                            locations);
                    // Save the location data to SharedPreferences.
                    locationResultHelper.saveResults();
                    // Show notification with the location data.
                    locationResultHelper.showNotification();
                    Log.i(TAG, com.wot.wotcursdk.LocationResultHelper.getSavedLocationResult(this));
                }
            }
        }
    }
